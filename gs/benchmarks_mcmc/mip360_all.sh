RESULT_DIR=results_mcmc/benchmark/360_v2
...
do
    ...
    # train without eval
    CUDA_VISIBLE_DEVICES=1 python simple_trainer_mcmc.py --eval_steps -1 --disable_viewer --data_factor $DATA_FACTOR \
    ...
    do
        CUDA_VISIBLE_DEVICES=1 python simple_trainer_mcmc.py --disable_viewer --data_factor $DATA_FACTOR \
            --data_dir data/360_v2/$SCENE \
            --result_dir $RESULT_DIR/$SCENE/ \
            --ckpt $CKPT
    done
